from utils.policy_compliance_checker import PolicyAndComplianceChecker


class S3PolicyAndComplianceChecker(PolicyAndComplianceChecker):

    def __init__(self, is_public: bool = False, is_encrypted: bool = False, is_versioning_enabled: bool = False, is_logging_enabled: bool = False):
        self.resource = "S3"
